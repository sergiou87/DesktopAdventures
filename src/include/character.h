...
extern const u8 CHAR_WALK_UP_ANIM[4];
extern const u8 CHAR_WALK_DOWN_ANIM[4];
extern const u8 CHAR_WALK_LEFT_ANIM[4];
extern const u8 CHAR_WALK_RIGHT_ANIM[4];
extern const u8 CHAR_WALK_UP_LEFT_ANIM[4];
extern const u8 CHAR_WALK_DOWN_LEFT_ANIM[4];
extern const u8 CHAR_WALK_UP_RIGHT_ANIM[4];
extern const u8 CHAR_WALK_DOWN_RIGHT_ANIM[4];

extern const u8 CHAR_ATTACK_UP_ANIM[4];
extern const u8 CHAR_ATTACK_DOWN_ANIM[4];
extern const u8 CHAR_ATTACK_LEFT_ANIM[4];
extern const u8 CHAR_ATTACK_RIGHT_ANIM[4];
extern const u8 CHAR_ATTACK_EXTEND_UP_ANIM[4];
extern const u8 CHAR_ATTACK_EXTEND_DOWN_ANIM[4];
extern const u8 CHAR_ATTACK_EXTEND_LEFT_ANIM[4];
extern const u8 CHAR_ATTACK_EXTEND_RIGHT_ANIM[4];

extern enum CHAR_DIRECTION {
    UP,
    DOWN,
    UP_LEFT,
    LEFT,
...
extern ichr_data **char_data;
extern chwp_entry **chwp_data;
extern caux_entry **caux_data;
